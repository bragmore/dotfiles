...
return function()
    ...
    vim.api.nvim_set_keymap("n", "<Localleader>gg", "<cmd>lua _lazygit_toggle()<CR>", { noremap = true, silent = true })
    ...
    function _G._set_terminal_keymaps()
        ...
        -- vim.api.nvim_buf_set_keymap(0, "t", "<Localleader><t>",
        --                             [[<cmd>ToggleTermOpenAll<CR>]], opts)
